...
class Profile
{
    ...
    public function fetch_missions()
    {
        $data = FortniteClient::sendUnrealClientGetRequest("https://fortnite-public-service-prod11.ol.epicgames.com/fortnite/api/game/v2/world/info", $this->access_token, true);
